...
class Analytify_Email_Core {
		...
		$email_fields = array(
			'wp-analytify-email' => array(
				...
				array(
					...
					'label'             => __( 'To Email Address', 'wp-analytify' ),
					'desc'              => __( 'Use commas to add more than One Email.', 'wp-analytify' ),
					'type'              => 'text',
					'default'           => '',
	...
	function callback_on_cron_time() {
		...
		foreach ( $when_to_send_report as $when ) {
								...
								<tr>
									<td style="padding: 20px 20px;">
										<table cellpadding="0" cellspacing="0" border="0" width="100%">
											<tr>
											<td valign="top" style="font: bold 14px \'Roboto\', Arial, Helvetica, sans-serif; padding-right:4px;"><font  color="#444444">Note: </font></td>
												<td style="font: normal 14px \'Roboto\', Arial, Helvetica, sans-serif;"><font color="#848484">We hope your weekly Analytics summaries encourage the efforts you are putting in your business. But if you no longer wish to receive Analytify Insights emails, you may change your preferences from plugin settings.</font><br><br></td>
											</tr>
										</table>
									</td>
								</tr>
			...
			$_from_email = ! empty( $_from_email ) ? $_from_email : 'support@analytify.io';
