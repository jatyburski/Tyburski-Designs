...
<section class="row no-gutters position-relative about__content about__content--full">
    <i class="far fa-telescope position-absolute" data-aos="zoom-in" role="presentation"></i>
...
<section id="<?php echo $id; ?>" class="row no-gutters position-relative about__content">
    <i class="far fa-planet-moon d-none d-md-block position-absolute" data-aos="zoom-in" role="presentation"></i>
